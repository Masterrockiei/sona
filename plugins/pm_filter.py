    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('I have sent files ✅',show_alert = True)
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAI0UmLSvk4wvFS1lae6AXBzC0rWbXpaAALaBAAC9QXxVeeIo315YOYGHgQ")
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʏᴏᴜ ᴛᴜʙᴇ', callback_data='music')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ', url='https://t.me/sakura_movie_update'),
        ...
        buttons = [[
            InlineKeyboardButton('👩‍🦯 𝐁𝐚𝐜𝐤', callback_data='close')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
